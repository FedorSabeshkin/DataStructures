...
class DeepAllNodesPreorderTest {
    ...
    */
    ...
    @Test
    public void WideAllNodes_Preorder_Count_Add_Child_By_Method_Last_Is_12() {
        BSTNode<Integer> root = new BSTNode(8, 8, null);
        BST tree = new BST(root);
        tree.AddKeyValue(4, 4);
        tree.AddKeyValue(12, 12);
        ...
        BSTNode[] array = {leaf_8, leaf_4, leaf_2, leaf_1, leaf_6, leaf_12, leaf_10, leaf_9, leaf_11, leaf_14};
        List<BSTNode> expectedList = Arrays.asList(array);
        assertIterableEquals(expectedList, tree.DeepAllNodes(BST.PRE_ORDER));
    }
